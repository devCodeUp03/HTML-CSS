...
// let numbers = [1, 2, 3];
// let doubledNumbers = numbers.map((el) => 2*el);
...
// let wholeNumbers = [1, 2, 3];

// let evenNumbers = wholeNumbers.filter((el) => el % 2 == 0);
// let oddNumbers = wholeNumbers.filter((el) => el % 2 == 1);
// console.log(evenNumbers);
...
// let sum = wholeNumbers.reduce((el, idx, sum) => {
//   // console.log(idx);
//   // console.log(sum);
...
// let numbers = [1, 2, 3, 4, 5];
// let sumOf = numbers.reduce((sum, el) => sum + el, 0)
// console.log(sumOf);

wholeNumbers = [1, 2, 3, 4, 5, 6, 7, 8];
let oddNumbers = wholeNumbers.filter((el) => {
  if(el % 2 != 0){
    return true;
  } else {
    return false;
  } //here return false or return undefined is the same value so no need to to add else block
});

console.log(oddNumbers);

//short hand to do the same task
let evenNumbers = wholeNumbers.filter( el => el % 2 !== 0);
