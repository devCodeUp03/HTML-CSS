...
// function firstLetterCapital(anyWord) {
//     let capital = anyWord[0].toUpperCase() + anyWord.slice(1).toLowerCase();//from 1 to the end
//     return capital;
// // }


// function findCountryCode(countryName) {
//     countryName = firstLetterCapital(countryName);
